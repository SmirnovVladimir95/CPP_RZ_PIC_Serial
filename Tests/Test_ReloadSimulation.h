#ifndef CPP_RZ_PIC_TEST_RELOADSIMULATION_H
#define CPP_RZ_PIC_TEST_RELOADSIMULATION_H
...
void test_ReloadSimulation() {
    cout << "test_ReloadSimulation: " << endl;
    ...
    int electron_Ntot = rows_count(electron_pos_path);
    cout << "electron_Ntot: " << electron_Ntot << endl;
    seed = 1;
    scalar m_e = E_M;
    Particles electrons(m_e, -1*EV, electron_Ntot, grid, ptcls_per_macro);
    ParticlesLoad load_electrons(electrons, electron_pos_path, electron_vel_path);
    ...
    int ion_Ntot = rows_count(ion_pos_path);
    cout << "ion_Ntot: " << ion_Ntot << endl;
    seed = 1;
    scalar m_ion = 7296. * m_e; // He+
    Particles ions(m_ion, EV, ion_Ntot, grid, ptcls_per_macro);
    ParticlesLoad load_ions(ions, ion_pos_path, ion_vel_path);
...
#endif //CPP_RZ_PIC_TEST_RELOADSIMULATION_H
