...
#include "../ElementaryProcesses/MonteCarloCollision.h"
...
void test_MonteCarloCollision() {
    double n = 1e20, mAr = 6.6335209e-26, T = 500;
    NeutralGas gas(n, mAr, T);
    double sigma=1e-19, dt=1e-9, mass=9.1e-31, charge=1.6e-19;
...
void test_MonteCarloCollisions() {
    ...
    electrons.generate_velocities(10*1.6e-19);
    array<type_double, 2> z_bounds = {0, Nz*dz}, r_bounds = {0, Nr*dr};
    ...
    double ion_threshold = 10*1.6e-19;
